...
public class ZillowRealEstateService {
    ...
    public static RestResponse getUpdatedPropertyDetails(String zpid) throws IOException {
        String apiKey = ZillowRealEstateServiceAuthenticator.getApiKey();
        String[][] pathParams = new String[][]{};
        String[][] queryParams = new String[][]{{"zws-id", "" + apiKey + ""}, {"zpid", zpid}};
        RestConnection conn = new RestConnection("http://www.zillow.com/webservice/GetUpdatedPropertyDetails.htm", pathParams, queryParams);
        return conn.get(null);
    }
}
